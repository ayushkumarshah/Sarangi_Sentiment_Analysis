prince_orig <- read.csv("tut_datasets/prince_raw_data.csv", stringsAsFactors = FALSE)
...
write.csv(prince, file = "tut_datasets/prince_new.csv")

prince_new <- read.csv("tut_datasets/prince_new.csv", stringsAsFactors = FALSE)
#View(prince_new)
