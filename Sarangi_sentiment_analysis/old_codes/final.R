...
Recall(newdata3[, 4],pred_default_sigmoid_nuh)
Precision(newdata3[, 4], pred_default_sigmoid_nuh)
F1_Score(newdata3[, 4], pred_default_sigmoid_nuh)
Accuracy(newdata3[, 4], pred_default_sigmoid_nuh)

pred_new_radialh<-predict(fit_new_radial,newdata3)

Recall(newdata3[, 4],pred_new_radialh)
Precision(newdata3[, 4], pred_new_radialh)
F1_Score(newdata3[, 4], pred_new_radialh)
Accuracy(newdata3[, 4], pred_new_radialh)
